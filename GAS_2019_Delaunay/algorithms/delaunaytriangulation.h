...
class DelaunayTriangulation
{
    public:
        /* --- Constructor --- */
        inline DelaunayTriangulation();
        inline DelaunayTriangulation(const Triangle &boundingTriangle);
        inline ~DelaunayTriangulation();
 ...
 **/
inline DelaunayTriangulation::DelaunayTriangulation(){
 ...
 */
inline DelaunayTriangulation::DelaunayTriangulation(const Triangle &boundingTriangle){
 ...
 */
inline const std::vector<Triangle>& DelaunayTriangulation::getTriangles() const{
 ...
 */
inline DagNode* DelaunayTriangulation::getDAG() const{
    return this->_dag;
}
 ...
 */
inline std::vector<Triangle> DelaunayTriangulation::getLeaves() const{
 ...
 */
inline std::vector<DagNode*>& DelaunayTriangulation::getAllDagNodes(){
 ...
 */
inline void DelaunayTriangulation::addTriangleToTriangulation (const Triangle &newTriangle){
 ...
 */
inline bool DelaunayTriangulation::isPointInNode(DagNode* &currentNode, const cg3::Point2Dd &point) const{
 ...
 */
inline void DelaunayTriangulation::clearDelaunayTriangulation (){
